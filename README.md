...
> **Baseline candidata aceita:** `1.14.1` — CS014 e CS015 passaram com evidência imutável nos runs `31381564124` e `31384684512`. O release público `v1.14.0` permanece histórico e imutável; `v1.14.1` ainda não foi publicado. A aceitação é restrita aos claims e limites registrados e não é certificação, auditoria externa, qualificação ARM64 ou garantia universal de desempenho.
...
|---|---|
| Baseline do produto | candidata aceita `1.14.1` (CS015 aprovado; release ainda não publicado) |
