...
#define NEOENG_DCORE_RUNTIME_VERSION_MINOR UINT16_C(14)
#define NEOENG_DCORE_RUNTIME_VERSION_PATCH UINT16_C(1)
...
#define NEOENG_DCORE_TRACE_CODE_TEMPORAL_RECORD_COMMITTED UINT32_C(30)
#define NEOENG_DCORE_TRACE_CODE_TEMPORAL_RECORD_REJECTED UINT32_C(31)
#define NEOENG_DCORE_TRACE_CODE_EXTERNAL_EFFECT_PREPARED UINT32_C(32)
#define NEOENG_DCORE_TRACE_CODE_EXTERNAL_EFFECT_COMMITTED UINT32_C(33)
#define NEOENG_DCORE_TRACE_CODE_EXTERNAL_EFFECT_COMPENSATED UINT32_C(34)
#define NEOENG_DCORE_TRACE_CODE_EXTERNAL_EFFECT_REJECTED UINT32_C(35)
