...
def main() -> int:
    ...
    summary = {
        ...
        "ecs_scope_acceptance_status": "not_implemented_in_1.6.0" if profile == "P1" else "not_required",
        ...
        "note": "Virtualized and containerized runs are engineering baselines and cannot qualify a profile. P1 complete ECS-scope acceptance is not implemented in 1.6.0.",
    }
